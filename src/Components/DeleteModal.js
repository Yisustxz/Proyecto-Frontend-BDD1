...
export default function DeleteModal({showModal, setShowModal}) {
  ...
  return (
    <div style={showModal ? modalStyle : { display: "none" }}>
      <h3 style={{marginTop: '20px', marginBottom: '20px', fontSize: '17px', fontWeight: 'bold'}}>¿Está seguro de que desea eliminar esto?</h3>
      <h3 style={{ marginBottom: '30px', fontSize: '15px'}}>Esta acción no podrá ser revertida</h3>
