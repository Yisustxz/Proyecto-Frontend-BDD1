...
export default function EditPro() {
    ...
    const handleSubmit = (event) => {
        ...
        console.log(`Los valores del formulario son: Nombre=${Nombre}, Descripcion=${Descrip}, Proveedor=${Provedor},EsEcologico =${EsEcologico}, Cantidad=${Cantidad}, Maximo=${Maximo}, Minimo=${Minimo}, codigo del tipo=${CodigoTipo}`);
    ...
    return (
        <div>
            ...
            <div style={{ position: 'absolute', top: '50vh', left: '58vw', backgroundColor: 'white', width: '35vw', maxHeight: '80vh', borderRadius: '10px', transform: 'translate(-50%, -50%', color: '#fff', zIndex: '2', display: 'flex', flexDirection: 'column', justifyContent: 'center', overflow: "scroll", overflowX: "hidden" }}>
                <h1 style={{ color: '#000', display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: '60vh', marginBottom: "2vh" ,fontSize: '24px', fontWeight: 'bold', fontSize: '28px' }}>Productos</h1>
                <form style={{ color: '#000', display: 'flex', flexDirection: 'column', justifyContent: 'center', marginLeft: '9.5vw', fontSize: '24px', fontWeight: 'bold' }} onSubmit={handleSubmit}>
