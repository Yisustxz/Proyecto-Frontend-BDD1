...
export default function AddManReco() {
    ...
    const handleSubmit = (event) => {
        ...
        console.log(`Los valores del formulario son: CodigoModelo=${CodigoModelo}, Nombre=${Codigo}, Correo=${Kilometraje}, Telefono primario=${TiempoUso}`);
    ...
    return (
        <div>
            ...
            <div style={{ position: 'absolute', top: '50vh', left: '58vw', backgroundColor: 'white', width: '35vw', minHeight: '80vh', borderRadius: '10px', transform: 'translate(-50%, -50%', color: '#fff', zIndex: '2', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <h1 style={{ color: '#000', display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: '1vh', fontSize: '24px', fontWeight: 'bold', fontSize: '28px' }}>Mantenimientos Recomendado</h1>
                <form style={{ color: '#000', display: 'flex', flexDirection: 'column', justifyContent: 'center', marginLeft: '9.5vw', marginTop: '3vh', fontSize: '24px', fontWeight: 'bold' }} onSubmit={handleSubmit}>
                    <label style={{ paddingBottom: '15px' }}> <h2 style={{ backgroundColor: '#1D324E', width: '5vw', display: 'flex', flexDirection: 'row', justifyContent: 'center', borderRadius: '10px', color: 'white', fontSize: '18px', marginBottom: '4px' }}>Codigo Modelo</h2>
