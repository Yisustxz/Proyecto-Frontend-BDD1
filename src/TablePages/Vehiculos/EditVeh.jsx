...
export default function EditVeh() {
    ...
    const handleSubmit = (event) => {
        ...
        console.log(`Los valores del formulario son: nUm de placa=${añoVehiculo}, cod de Servicio=${NumSerial}, Fecha Reservada=${NumMotor}, asistencia=${Color} , Tipo de servicio=${FechaVenta} , Kilometraje=${ConcesionarioVendedor}, asistencia=${Info} , Tipo de servicio=${CodModelo} , Kilometraje=${Cedula}`);
    ...
    return (
        <div>
            ...
            <div style={{ position: 'absolute', top: '50vh', left: '58vw', backgroundColor: 'white', width: '35vw', maxHeight: '80vh', borderRadius: '10px', transform: 'translate(-50%, -50%', color: '#fff', zIndex: '2', display: 'flex', flexDirection: 'column', justifyContent: 'center', overflow: "scroll", overflowX: "hidden" }}>
                <h1 style={{ color: '#000', display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: '69vh', fontSize: '24px', fontWeight: 'bold', fontSize: '30px' }}>Vehiculo</h1>
