...
export default function EditPagos() {
    ...
    const handleSubmit = (event) => {
        ...
        console.log(`Los valores del formulario son: la modalidad del pago=${Modalidad}, Fecha del pago=${Fecha}, Monto=${Monto}, numero de Tarjeta=${NumTarjeta} , Banco=${Banco}`);
    ...
    return (
        <div>
            ...
            <div style={{ position: 'absolute', top: '50vh', left: '58vw', backgroundColor: 'white', width: '35vw', maxHeight: '80vh', borderRadius: '10px', transform: 'translate(-50%, -50%', color: '#fff', zIndex: '2', display: 'flex', flexDirection: 'column', justifyContent: 'center', overflow: "scroll", overflowX: "hidden" }}>
                <h1 style={{ color: '#000', display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: '6vh', fontSize: '24px', fontWeight: 'bold', fontSize: '30px' }}>Pagos</h1>
